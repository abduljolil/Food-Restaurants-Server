...
async function run() {
  try {
    ...
    const userCollection = client.db("Food-Restaurants").collection("users");
    const menuCollection = client.db("Food-Restaurants").collection("menu");
    const reviewCollection = client.db("Food-Restaurants").collection("reviews");
    const cartCollection = client.db("Food-Restaurants").collection("carts");
    const paymentCollection = client.db("Food-Restaurants").collection("payments");
